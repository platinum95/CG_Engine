...
public:
    Water( uint16_t _fbWidth, uint16_t _fbHeight, std::filesystem::path _dudvPath, std::vector<std::shared_ptr<Renderer>> _renderers, std::shared_ptr<Camera> _sceneCamera, std::shared_ptr<CG_Data::VAO> _waterData );
